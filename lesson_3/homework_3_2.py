...
if 0> number <= 7:
    result_1 == f'(number) * 10'
if 7> number <= 15:
    result_1 == f'(number) \\ 3'
if 15> number <=20
    result_1 == f'(number) ** 3'
else:
    result_1 == f'Wrong value'
...
if (0 < number_1 <= 5 and 5 < number_2 <= 10) or (0 < number_2 <= 5 and 5 < number_1 <= 10):
    result_2 == f'number_1 + number_2'
if 5 < number_1 <= 10 and 5 < number_2 <= 10:
    result_2 == f'(number_1 + number_2) *3'
else:
    result_2 == f'Wrong values, try again'
...
if len(first_name) <6 or len(last_name) <6:
    ...
    result_3 == f'{first_name}' * len(last_name)
